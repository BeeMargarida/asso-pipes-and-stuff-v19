...
//     constructor(public readonly f: Filter, public inQueue: AsyncQueue, public outQueue: AsyncQueue) { }
//     next(): Message {
...
//     lines: string[]
//     constructor(public readonly fileName: string, public inQueue: AsyncQueue, public outQueue: AsyncQueue) {
...
//     constructor(public readonly fileName: string, public inQueue: AsyncQueue, public outQueue: AsyncQueue) {
//         super(fileName,inQueue,outQueue);
//     }  
//     delay(millis: number) {
//         const date = new Date()
//         let curDate = null
